...
<html lang="en">
  ...
  <div class="row ">
    ...
    <div class="text-center lh-1">
      ...
      <span class="fw-light">Admin Login</span>
      </div>
...
<% } %>
    ...
    <span class="btn btn-success "> <a class="text-decoration-none text-white" href="index.jsp">User Login</a></span>
    </div>
        </form>
       <div class="mt-1">
<span class="fw-light" >Dont't have account? <a href="Adminindex.jsp">Create Account</a></span>
</div>
</div>
</div>
</div>
